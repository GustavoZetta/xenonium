...
### Week 0 (09/01) - Preparing
Week "burned" to prepare for the project (burocratic work) and plan following weeks.

### Week 1 (09/06) - Game Engine Foundamentals
...
- [ ] Create this GitHub repository and initiate of the folder structure
...
Actions:
- [ ] Study ``std::pmr`` (Polymophic Memory Resources) - planned beforehand to be investigated
- [ ] Write small prototypes to fixate concepts in a ``experiments/`` folder.
- [ ] Add how each CUPID principle will manifest in real code to the **Research Log**

### Week 3 (09/20) - Comparative Architecture Study
Objective: Study, analize and compare architecture planned to projects as [GLM](https://github.com/g-truc/glm), [EnTT](https://github.com/skypjack/entt) and Reference Engines <br>
Material to read:
...
- [ ] Create a prototype of the comparative table for [GLM](https://github.com/g-truc/glm) and [EnTT](https://github.com/skypjack/entt)
